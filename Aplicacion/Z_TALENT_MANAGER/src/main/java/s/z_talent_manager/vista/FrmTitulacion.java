...
// ── Paleta ───────────────────────────────────────────────────
    ...
    private void construirUI() {
        ...
        String[] columnas = {"Titulación", "Tipo de estudio", "Fecha inicio", "Fecha fin", "En curso", "Centro Formativo"};
    ...
    public void cargarDatos(List<CandidatoTitulacion> titulaciones) {
        ...
        for (CandidatoTitulacion tit : titulaciones) {
            ...
            // Extraer los nombres exactos en orden
            ...
            modeloTabla.addRow(new Object[]{
                nombreTitulacion, // 0: Titulación
                tipoEstudio,      // 1: Tipo de estudio
                fechaInicio,      // 2: Fecha inicio
                fechaFin,         // 3: Fecha fin
                enCurso,          // 4: En curso (Checkbox boolean)
                centroFormativo   // 5: Centro Formativo
            });
        }
    }
